...
inline void RoofClass::homeInterrupt()
{
    long  nPos;
...
long RoofClass::GetAzimuthToPosition(const float azimuth)
{
    long newPosition;
...
void RoofClass::SyncPosition(const float newAzimuth)
{
    long newPosition;
...
void RoofClass::GoToAzimuth(const float newHeading)
{
    // Goto new target
...
long RoofClass::GetStepsPerRotation()
{
    return m_Config.stepsPerRotation;
}

void RoofClass::SetStepsPerRotation(const long newCount)
{
...
float RoofClass::GetAngularDistance(const float fromAngle, const float toAngle)
{
    float delta;
...
// home and park methods
//
float RoofClass::GetHomeAzimuth()
{
    return m_Config.homeAzimuth;
}

void RoofClass::SetHomeAzimuth(const float newHome)
{
    m_Config.homeAzimuth = newHome;
    SaveToEEProm();
}

int RoofClass::GetHomeStatus()
{
...
float RoofClass::GetParkAzimuth()
{
    return m_Config.parkAzimuth;
}

void RoofClass::SetParkAzimuth(const float newPark)
{
