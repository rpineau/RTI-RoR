...
#define MyAppName "RTI-RoR X2 PlugIn"
...
OutputBaseFilename=RTI-RoR_X2_Installer
; Final one is the icon you would like on the installer. Comment out if not needed.
SetupIconFile=rti_zone_logo.ico
Compression=lzma
SolidCompression=yes
; We don't want users to be able to select the directory since read by TSXInstallDir below
DisableDirPage=yes
...
[Files]
Source: "domelist RTI-RoR.txt";                        DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion
Source: "domelist RTI-RoR.txt";                        DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion; DestName: "domelist64 RTI-RoR.txt"
; 32 bits
Source: "libRTI-RoR\Win32\Release\libRTI-RoR.dll";    DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
Source: "RTI-RoR.ui";                                  DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
Source: "RTI-Zone.png";                                 DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
; 64 bits
Source: "libRTI-RoR\x64\Release\libRTI-RoR.dll";      DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion
Source: "RTI-RoR.ui";                                  DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion
